...
2. PRD 模板：`docs/templates/{projectType}/prd.md`
3. 现有 PRD：`docs/prd.md`（如存在）
...
5. 保留未变更的章节，只修改相关部分
6. 确保锚点和结构完整
7. 输出更新后的 `docs/prd.md`

**最后**：
- 运行校验：`npm run validate:docs docs/prd.md`，确保符合规范
