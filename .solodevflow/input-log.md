...
**原始输入**：
> 项目中设计深度级别有4个，是不是太多了，我觉得只需要2个，无设计和有设计，至于如何设计，有设计规范指导就行了

**类型**：变更

**阶段**：feature_requirements

**归纳**：简化 Design Depth 为 2 级（none/required），移除 L0-L3，由设计规范指导具体深度
...
**原始输入**：
> 我们的claude.md应该和元规范一样，不轻易修改，我们应该修改PRD中关于工作流的实现，不用claude.md实现，而是用一个专门的规范文档实现，claude.md只是引用它

**类型**：变更

**阶段**：feature_requirements

**归纳**：重构 CLAUDE.md 架构 - 分离流程定义到专门规范文档，CLAUDE.md 只作为索引引用
